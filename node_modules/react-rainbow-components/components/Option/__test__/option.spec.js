...
describe('<Option />', function () {
  ...
  it('should render a option header when variant is header', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_.OptionItem, {
      label: "Header 1",
      variant: "header"
    }));
  ...
  it('should not register when is disabled', function () {
    (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_.OptionItem, {
      disabled: true
    }));
  ...
  it('should fire an event with the right data when click the option', /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee() {
    var data, component;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_.OptionItem, {
              label: "option 1",
              name: "option1",
  ...
  it('should fire an event with the right data when hover the option', function () {
    var component = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_.OptionItem, {
      label: "option 1",
      name: "option1",
