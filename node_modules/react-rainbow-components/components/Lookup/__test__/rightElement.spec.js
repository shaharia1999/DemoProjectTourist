...
describe('<RightElement />', function () {
  it('should render an icon container', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_rightElement["default"], null));
  ...
  it('should render a close button when showCloseButton is passed', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_rightElement["default"], {
