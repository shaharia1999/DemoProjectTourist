...
describe('<SelectedValue />', function () {
  it('should render an input container', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_selectedValue["default"], {
      value: valueWithIcon
    }));
  ...
  it('should not render an icon container', function () {
    ...
    expect(component.find(_selectedValueIcon["default"]).exists()).toBe(false);
  });
  it('should render an icon container', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_selectedValue["default"], {
      value: valueWithIcon
    }));
    expect(component.find(_selectedValueIcon["default"]).exists()).toBe(true);
  });
  it('should render a close button', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_selectedValue["default"], null));
