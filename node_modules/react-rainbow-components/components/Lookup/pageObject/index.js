...
var PageLookup = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(PageLookup, [{
    ...
    value: function getOption(itemPosition) {
      var items = $('[data-id="lookup-options-container"]').$$('li[role="presentation"]');
    ...
    value: function hoverScrollUpArrow() {
      var upArrow = $('[data-id="lookup-options-container"]').$('[data-id=lookup-arrow-button-up]');
    ...
    value: function hoverScrollDownArrow() {
      var downArrow = $('[data-id="lookup-options-container"]').$('[data-id="lookup-arrow-button-down"]');
    ...
    value: function arrowDownExists() {
      return $('[data-id="lookup-options-container"]').$('[data-id="lookup-arrow-button-down"]').isExisting();
    }
    /**
     * Returns true when the the arrow to scroll down exits, false otherwise.
     * @method
    ...
    value: function arrowUpExists() {
      return $('[data-id="lookup-options-container"]').$('[data-id="lookup-arrow-button-up"]').isExisting();
    }
  }]);
  return PageLookup;
}();
