...
describe('<Drawer />', function () {
  ...
  it('should fire an event when the drawer is opened', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_["default"], {
                isOpen: true,
  ...
  it('should call enableBodyScroll when drawer is closed', /*#__PURE__*/function () {
