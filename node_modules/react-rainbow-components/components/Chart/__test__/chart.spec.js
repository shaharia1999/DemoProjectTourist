...
describe('<Chart />', function () {
  it('should call ChartJS to render the chart when the component is mounted', function () {
    (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_index.Chart, {
      labels: ['A', 'B', 'C', 'D'],
      type: "line"
    }, /*#__PURE__*/_react["default"].createElement(_Dataset["default"], {
  ...
  it('should call ChartJS update method to update the chart when the component changes', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_index.Chart, {
      labels: ['A', 'B', 'C', 'D'],
      type: "line"
    }));
  ...
  it('should call ChartJS update method to update the chart when the children changes', function () {
    ...
    component.setProps({
      children: [/*#__PURE__*/_react["default"].createElement(_Dataset["default"], {
