...
var PageRadioGroup = /*#__PURE__*/function () {
  /**
  ...
  (0, _createClass2["default"])(PageRadioGroup, [{
    ...
    value: function getItem(itemPosition) {
      var items = $(this.rootElement).$$('[data-id="input-radio_container"]');

      if (items[itemPosition]) {
        return new PageRadioItem("".concat(this.rootElement, " [data-id=\"input-radiogroup_container\"]:nth-child(").concat(itemPosition + 1, ")"));
      }
