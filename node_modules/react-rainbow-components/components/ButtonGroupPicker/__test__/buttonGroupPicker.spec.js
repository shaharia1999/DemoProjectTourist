...
describe('<ButtonGroupPicker />', function () {
  it('should pass the right props to the Label component', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_index.Component, {
      label: "custom label",
      required: true
    }));
  ...
  it('should pass type checkbox in context when multiple is true', function () {
    var component = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_index.Component, {
      multiple: true
    }));
  ...
  it('should pass type radio in context when multiple is false', function () {
    var component = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_index.Component, null));
    var context = component.find(_context.Provider).prop('value');
