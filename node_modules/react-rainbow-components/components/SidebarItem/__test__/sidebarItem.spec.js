...
describe('<SidebarItem when href is passed />', function () {
  it('should have aria-current of page if isSelected', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Sidebar["default"], {
  ...
  it('should render the right icon when the item is selected', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Sidebar["default"], {
      ...
      selectedIcon: /*#__PURE__*/_react["default"].createElement(_reactFontawesome.FontAwesomeIcon, {
        icon: _freeSolidSvgIcons.faClock
      }),
...
describe('<SidebarItem />', function () {
  it('should render a tooltip when passed', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Sidebar["default"], null, /*#__PURE__*/_react["default"].createElement(_index["default"], {
      icon: /*#__PURE__*/_react["default"].createElement(_reactFontawesome.FontAwesomeIcon, {
        icon: _freeSolidSvgIcons.faClock
      }),
      name: "sidebaritem-test-2",
