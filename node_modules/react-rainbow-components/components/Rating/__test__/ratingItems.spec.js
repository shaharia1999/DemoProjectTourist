...
describe('<RatingItems />', function () {
  it('should pass the right props to the Star component', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_ratingItems["default"], {
      value: "1",
      name: "name-1",
  ...
  it('should render the right amount of Star components', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_ratingItems["default"], null));
