...
describe('Calendar', function () {
  ...
  it('should set the right attributes in table element', function () {
    var value = new Date('04/24/2019');
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_.Component, {
      value: value
    }));
  ...
  it('should fire onChange with a date as parameter when selectionType is single', function () {
    ...
    var simpleCalendar = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_["default"], {
      value: value,
