...
var mountWithRef = function mountWithRef(elWithRef, options) {
  ...
  return (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(WithRef, null), options);
};
...
describe('<PrimitiveMenu/>', function () {
  ...
  it('should set the isLoading passed in the MenuContent', /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee() {
    var component;
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_["default"], {
              trigger: _ButtonIcon["default"],
              isLoading: true
