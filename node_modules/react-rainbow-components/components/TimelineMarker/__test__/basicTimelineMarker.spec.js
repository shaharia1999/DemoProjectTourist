...
describe('<BasicTimelineMarker/>', function () {
  it('should render the children passed', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_basicMarker["default"], null, /*#__PURE__*/_react["default"].createElement(_Card["default"], {
  ...
  it('should render the icon passed', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_basicMarker["default"], {
  ...
  it('should render the calendar icon by default', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_basicMarker["default"], null));
