...
describe('<ZoomableImage />', function () {
  it('should call close when clicked', function () {
    var close = jest.fn();
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_zoomedImage["default"], {
  ...
  it('should close when Escape key is pressed', function () {
    var close = jest.fn();
    (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_zoomedImage["default"], {
      src: "https://via.placeholder.com/450",
      originalRect: {},
      close: close
    }));
