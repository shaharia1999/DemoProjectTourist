                        ...
                        <Row className="justify-content-center">
                            <Col xl={6} lg={6} md={6} sm={12} xs={12} className="text-center">
                               {/* <div className="input-group searchTop">
                                ...
                                <h4 className="searchUpText justify-content-center mb-4">Over 157,000 hotels and homes across 35 countries</h4>
                                <div className="input-group mb-3">
                                    <input type="text" className="form-control" placeholder="Search by City, Hotel or Location"
